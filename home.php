<?php 
  ...
  $query = mysqli_query($conn,"SELECT * FROM customer WHERE customer_email='$user'");
  $row=mysqli_fetch_array($query);
 echo $_SESSION['card_id'] = $row['customer_card_num'];
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
.w3-col,.w3-half,.w3-third,.w3-twothird,.w3-threequarter,.w3-quarter{width:100%}
...
body.darkpagetheme .w3-info {background-color:rgb(21,32,43);}
...
<form action="far.php?type=1"  method="post"> 
...
<div class="w3-col m6"><strong> <p style="
    background-color: black;
    color: white;
    font-size: 27px;">مونوريل</p></strong>
<p><strong>قيام</strong></p>

<!--surround the select box with a "custom-select" DIV element. Remember to set the width:-->
<div class="custom-select" style="width:200px;">
  <select name="from">
    <option value="1">اختر محطة القيام:</option>
    <option value="2">العاصمة الاداريه</option>
    <option value="3">6 اكتوبر</option>
    <option value="4">مدينة نصر</option>
    <option value="5">التجمع الخامس</option>


  </select>
<div class="select-selected" style="display:none">Select car:</div><div class="select-items select-hide"><div>Audi</div><div>BMW</div><div>Citroen</div><div>Ford</div><div>Honda</div><div>Jaguar</div><div>Land Rover</div><div>Mercedes</div><div>Mini</div><div>Nissan</div><div>Toyota</div><div>Volvo</div></div></div>
</div><div class="w3-col m6">
<p><strong>وصول:</strong></p>

<!--surround the select box with a "custom-select" DIV element. Remember to set the width:-->
<div class="custom-select" style="width:200px;">
  <select name="to">
    <option value="6">اختر محطة الوصول:</option>
    <option value="7">العاصمة الاداريه</option>
    <option value="8">6 اكتوبر</option>
    <option value="9">مدينة نصر</option>
    <option value="10">التجمع الخامس</option>


  </select>
<div class="select-selected" style="display:none">Select car:</div><div class="select-items select-hide"><div>Audi</div><div>BMW</div><div>Citroen</div><div>Ford</div><div>Honda</div><div>Jaguar</div><div>Land Rover</div><div>Mercedes</div><div>Mini</div><div>Nissan</div><div>Toyota</div><div>Volvo</div></div></div>
</div><div class="w3-col m6">
<p><strong>عدد الافراد:</strong></p>

<!--surround the select box with a "custom-select" DIV element. Remember to set the width:-->
<div class="custom-select" style="width:200px;">
  <select name="count">
    <option value="11">حدد عدد الافراد:</option>
...
<form action="far.php?type=2"  method="post">

<br>

<div class="w3-row" style="background-color: #ffffff20;
...
<div class="custom-select" style="width:200px;">
  <select name="from">
    ...
    <option value="3">المحلة الكبرى</option>
    <option value="4">طنطا</option>
    <option value="5">قويسنا</option>
...
<div class="custom-select" style="width:200px;">
  <select name="to">
    <option value="6">اختر محطة الوصول:</option>
    <option value="7">المنصوره</option>
    <option value="8">المحله الكبرى</option>
    <option value="9">طنطا</option>
    <option value="10">قويسنا</option>
...
<form action="far.php?type=3" method="post">
...
<div class="custom-select" style="width:200px;">
  <select name="from">
    <option value="1">اختر محطة القيام:</option>
    <option value="2">حلوان</option>
    <option value="3">المرج الجديد</option>
    <option value="4">شبرا</option>
    <option value="5">المنيب</option>
...
<div class="custom-select" style="width:200px;">
  <select name="to">
    <option value="6">اختر محطة الوصول:</option>
    <option value="7">حلوان</option>
    <option value="8">المرج الجديد</option>
    <option value="9">شبرا</option>
    <option value="10">المنيب</option>
